...
// export const addToCart = (product: Product, selectedQuantity: number) => {
...
//     } else {
//         cart.push({ ...product, quantity: selectedQuantity || 1 });
//     }
...
//     return updatedCart;  // ✅ Updated cart return karega
// };

// export const updateCartQuantity = (productId: string, quantity: number) => {
//     if (quantity < 1) return getCartItems();  // ✅ Prevent invalid quantity
